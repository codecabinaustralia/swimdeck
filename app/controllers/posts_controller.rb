class PostsController < ApplicationController
  ...
  def close_note
    ...
    redirect_to student_path(@post.student_id)
  end
  ...
  private
    ...
    def post_params
      params.require(:post).permit(:student_id, :user_id, :clients, :body, :note, :note_closed, :level_id, :certificate, :skill_id, :sms, files: [])
    end
end
