...
class FlagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flag" do
    assert_difference('Flag.count') do
      post flags_url, params: { flag: { number_of_days: @flag.number_of_days, title: @flag.title } }
    end
  ...
  test "should update flag" do
    patch flag_url(@flag), params: { flag: { number_of_days: @flag.number_of_days, title: @flag.title } }
